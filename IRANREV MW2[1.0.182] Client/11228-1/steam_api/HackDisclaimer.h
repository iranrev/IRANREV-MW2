...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(255, 119);
			...
			this->checkBox1->Size = System::Drawing::Size(232, 17);
			this->checkBox1->TabIndex = 4;
			this->checkBox1->Text = L"I am aware of the repercussions of cheating";
			this->checkBox1->UseVisualStyleBackColor = true;
			this->checkBox1->CheckedChanged += gcnew System::EventHandler(this, &HackDisclaimer::checkBox1_CheckedChanged);
			// 
			// HackDisclaimer
			// 
