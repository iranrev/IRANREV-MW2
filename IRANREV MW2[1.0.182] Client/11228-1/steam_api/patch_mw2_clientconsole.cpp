...
CallHook4D1 clKeyEventToggleConsoleHook1;
DWORD clKeyEventToggleConsoleHook1Loc =	0x4F690C;

StompHook4D1 clKeyEventToggleConsoleHook2;
...
StompHook4D1 drawCmdMatchAlternativeHook;
DWORD drawCmdMatchAlternativeHookLoc = 0x5A3EB6;
StompHook4D1 drawDvarMatchAlternativeHook;
DWORD drawDvarMatchAlternativeHookLoc = 0x5A3DC2;
StompHook4D1 completeCmdMatchAlternativeHook;
DWORD completeCmdMatchAlternativeHookLoc = 0x5A73B8;
StompHook4D1 completeDvarMatchAlternativeHook;
