...
const char* wtf = "PATCH ON A STRING. THE OFFICIAL SOLUTION FOR PATCHING STRINGTABLES!";
...
const char* LocalizeString(const char* name)
{
	...
	{
		//return "YOU WANT PLAY";
		//return "^3Iran Revolution";
		return "^7IRAN ^5REV^7OLUTION";
	}
	...
	{
		//return "If this button does not respond, no admin is available.";
		//return "This button might be replaced by a server list.";
		return "View a listing of dedicated servers.";
	}

	if (!strcmp(name, "MPUI_DESC_INVITE_FRIENDS"))
	{
		//return "If this button does not respond, no admin is available.";
		//return "This button will be gone.";
	}
	...
	if (!strcmp(name, "PLAYERCARDS_TITLE_FNG"))
	{
		//return "^3Iran Revolution";
		//return "^3Iran Revolution";
		return "^7IRAN ^5REV^7OLUTION";
	}
	/*if (!strcmp(name, "PLAYERCARDS_TITLE_30"))
	{
		return "^3www.iw4.ir";
	}
	if (!strcmp(name, "PLAYERCARDS_TITLE_20"))
	{
		return "^3www.iw4play.ir";
	}*/
	if (!strcmp(name, "MENU_JOIN_SERVER"))
	{
		//return "^3Iran Revolution Serverlist";
		return "^7Iran ^5Rev^7olution ^7Serverlist";
	}
	if (!strcmp(name, "MENU_JOIN_SERVER_CAP"))
	{
		//return "^3Iran Revolution Serverlist";
		return "^7Iran ^5Rev^7olution ^7Serverlist";
	}
	/*if (!strcmp(name, "PLAYERCARDS_TITLE_FLAG_IRAN"))
	{
		return "^3Iran Revolution";//cardtitle_flag_iran
	}
...
void StringLingInit()
{
	...
	OutputDebugStringA("StringLingInit()");
